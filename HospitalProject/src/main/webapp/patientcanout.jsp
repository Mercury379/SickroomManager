        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="/pcanout?method=search" method="post">
            ...
            <div class="table-responsive">
                            ...
                            <td>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger "
                                            data-id="${liveCert.getTime()}" data-toggle="modal"
                                            data-username="${liveCert.getLno()}"
                                            data-password="${liveCert.getPno()}"
                                            data-name="${liveCert.getName()}"
                                            data-gender="${liveCert.getDname()}"
                                            data-telephone="${liveCert.getDepartment()}"
                                            data-time="${liveCert.getPreouttime()}"
                                            data-status="${liveCert.getStatus()}"
                                            data-toggle="modal"
                                            onclick="" data-target="#updateUserModal">
                                        <i class="fa fa-search">打印出院许可</i>
                                    </button>
                                </div>
                            </td>
                        </tr>
                ...
                <form method="post" action="/pcanout?method=print" class="form-horizontal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">出院信息</h4>
                                </div>
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <label for="id" class="col-sm-3 control-label">出院证明产生时间</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-3 control-label">病人姓名</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="gender" class="col-sm-3 control-label">医生姓名</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="telephone" class="col-sm-3 control-label">所属科室</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="time" class="col-sm-3 control-label">建议出院时间</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary">确定打印该出院证明</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                <div class="modal fade" id="paymentAlertModal" tabindex="-1" role="dialog" aria-labelledby="paymentAlertModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="paymentAlertModalLabel">出院证明打印失败提示</h5>
...
<script>
    $('#updateUserModal').on('show.bs.modal', function(event) {
        ...
        modal.find('.modal-title').text('打印出院许可')
