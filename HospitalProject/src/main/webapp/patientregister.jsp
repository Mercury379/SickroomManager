        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="/pregister?method=search" method="post">
...
<%--                                                    </c:forEach>--%>
                                        ...
                                        <div class="form-group">
                                            <label for="preintime" class="col-sm-3 control-label">预约挂号时间时间</label>
                                            <div class="col-sm-9">
                                                <input type="date" class="form-control" id="preintime"
                                                       name="preintime" placeholder="请输入预约挂号时间">
                                            </div>
                                        </div>
