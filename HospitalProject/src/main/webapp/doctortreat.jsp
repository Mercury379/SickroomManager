        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="/dtreat?method=search" method="post">
                        <div class="form-group">
                            <label for = "patientidvalue" class="panel-heading">挂号号</label>
                            <input class="form-control" type="text" name="patientidvalue" placeholder="请输入挂号号" id="patientidvalue"/>
                        </div>
                        <div class="form-group">
                            ...
                            <td>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-danger "
                                            data-id="${treatInfo.getTno()}"
                                            data-toggle="modal"
                                            onclick="" data-target="#updateUserModal">
                                        <i class="fa fa-search">填写具体病例</i>
                                    </button>
                                </div>
                            </td>
                        </tr>
