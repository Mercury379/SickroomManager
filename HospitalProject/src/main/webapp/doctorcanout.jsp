        ...
        <div class="col-sm-10">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" class="form-inline" action="/dlivecanout?method=search" method="post">
            ...
            <div class="table-responsive">
                <table class="table table-hover ">
                    ...
                    <tbody>
                    <c:forEach items="${list}" var="liveInfo">
                        <tr>
                            <td>${liveInfo.getLNo()}</td>
                            <td>${liveInfo.getPNo()}</td>
                            <td>${liveInfo.getPName()}</td>
                            <td>${liveInfo.getRno()}</td>
                            <td>${liveInfo.getBno()}</td>
                            <td>${liveInfo.getInTime()}</td>
                            <td>
                                <div class="btn-group">
                                    <button type="button" class="btn btn-success "
                                            data-id="${liveInfo.getLNo()}" data-toggle="modal"
                                            data-toggle="modal"
                                            onclick="" data-target="#updateUserModal">
                                        <i class="fa fa-user-o">办理出院证明</i>
                                    </button>
                                </div>
                            </td>
                        </tr>
                ...
                <form method="post" action="/dlivecanout?method=update" class="form-horizontal"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title" id="myModalLabel">办理出院许可</h4>
                                </div>
                                <div class="modal-body">
                                    <form class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group">
                                            <label for="preouttime" class="col-sm-3 control-label">建议出院时间</label>
                                            <div class="col-sm-9">
                                                <input type="date" required class="form-control" id="preouttime"
                                                       name="preouttime" placeholder="请输入用户名">
                                            </div>
                                        </div>
...
<script>
    $('#updateUserModal').on('show.bs.modal', function(event) {
        ...
        var preouttime = button.data('username')
        var gender = button.data('gender')
        var telephone = button.data('telephone')
        var modal = $(this)

        modal.find('.modal-title').text('办理出院许可')
        modal.find('#id').val(id)
        modal.find('#preouttime').val(preouttime)
